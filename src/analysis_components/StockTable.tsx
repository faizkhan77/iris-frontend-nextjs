...
export default function StockTable({
  ...
  const currentStocks = stocks.slice(firstItemIndex, lastItemIndex);

  // Reset to page 1 if filters change the data
      ...
      <div className="space-y-8">
        ...
        {!stocks || stocks.length === 0 ? (
          ...
          <>
            ...
            />
            <div className="overflow-x-auto rounded-lg border border-element-border shadow-xl scrollbar-hide">
